...
GRPC_VERSION=${GRPC_VERSION:-1.52}
GRPC_JAVA_VERSION=${GRPC_JAVA_VERSION:-1.53}
GRPC_WEB_VERSION=${GRPC_WEB_VERSION:-1.4.2}
GRPC_GATEWAY_VERSION=${GRPC_GATEWAY_VERSION:-v2.15.2}
